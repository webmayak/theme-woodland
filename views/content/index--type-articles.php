...
?><div class="articles-page">
	...
	<div class="articles-page__summary">
		<div class="articles-page__date"><?= Yii::$app->formatter->asDate($model->created_at) ?></div>
		<script src="https://yastatic.net/es5-shims/0.0.2/es5-shims.min.js"></script>
		<script src="https://yastatic.net/share2/share.js"></script>
		<div class="articles-page__share">
			<div class="articles-page__share-label">Рассказать друзьям</div>
			<div class="articles-page__share-buttons">
	...
	<?php endif; ?>
	<?php if ($model->body) : ?>
	    <div class="articles-page__body editor-content editor-content__page">
	        <?= $model->body ?>
	    </div>
	<?php endif; ?>
</div>
