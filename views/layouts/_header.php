...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">
    <symbol id="icon-city" viewbox="0 0 97.713 97.713" fill="currentColor">
    ...
    <symbol id="icon-tel" viewbox="0 0 401.998 401.998" fill="currentColor">
    ...
    <symbol id="icon-email" viewbox="0 0 550.795 550.795" fill="currentColor">
    ...
    <symbol id="icon-mode" viewbox="0 0 299.995 299.995" fill="currentColor">
    ...
    <symbol id="icon-address" viewbox="0 0 460.298 460.297" fill="currentColor">
    ...
    <symbol id="icon-vk" viewbox="0 0 548.358 548.358" fill="currentColor">
    ...
    <symbol id="icon-fb" viewbox="0 0 96.124 96.123" fill="currentColor">
    ...
    <symbol id="icon-youtube" viewbox="0 0 310 310" fill="currentColor">
    ...
    <symbol id="icon-instargam" viewbox="0 0 512 512" fill="currentColor">
    ...
    <symbol id="icon-ok" viewbox="0 0 24 24" fill="currentColor">
        <path d="M4.721 12.881c-.613 1.205.083 1.781 1.671 2.765 1.35.834 3.215 1.139 4.413 1.261l-4.721 4.541c-1.374 1.317.838 3.43 2.211 2.141l3.717-3.585c1.423 1.369 2.787 2.681 3.717 3.59 1.374 1.294 3.585-.801 2.226-2.141-.102-.097-5.037-4.831-4.736-4.541 1.213-.122 3.05-.445 4.384-1.261l-.001-.001c1.588-.989 2.284-1.564 1.68-2.769-.365-.684-1.349-1.256-2.659-.267 0 0-1.769 1.355-4.622 1.355-2.854 0-4.622-1.355-4.622-1.355-1.309-.994-2.297-.417-2.658.267z"/><path d="M11.999 12.142c3.478 0 6.318-2.718 6.318-6.064 0-3.36-2.84-6.078-6.318-6.078C8.52 0 5.68 2.718 5.68 6.078c0 3.346 2.84 6.064 6.319 6.064zm0-9.063c1.709 0 3.103 1.341 3.103 2.999 0 1.644-1.394 2.985-3.103 2.985S8.896 7.722 8.896 6.078c-.001-1.659 1.393-2.999 3.103-2.999z"/>
    </symbol>
