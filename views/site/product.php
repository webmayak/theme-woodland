        ...
        <div class="row align-items-start">
            ...
            <div class="col-lg-4">
                <div class="product-page__sidebar">
                    <button class="product-page__order-btn btn btn-success btn-block text-uppercase">Заказать этот проект</button>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="product-table__price-wrap">
                                    ...
                                    <span class="product-table__price">260 000 руб.</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label class="product-table__price-wrap">
                                    ...
                                    <span class="product-table__price">320 000 руб.</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label class="product-table__price-wrap">
                                    <input class="sr-only" type="checkbox">
                                    <span class="product-table__price">390 000 руб.</span>
                                </label>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="product-page__sidebar-table product-table">
                        <tr>
                            ...
                            <td>
                                <label class="product-table__price-wrap">
                                    <input class="sr-only" type="checkbox" checked>
                                    <span class="product-table__price">430 000 руб.</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label class="product-table__price-wrap">
                                    <input class="sr-only" type="checkbox">
                                    <span class="product-table__price">490 000 руб.</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label class="product-table__price-wrap">
                                    <input class="sr-only" type="checkbox">
                                    <span class="product-table__price">510 000 руб.</span>
                                </label>
                            </td>
                        </tr>
                    </table>
